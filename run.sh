...
CUDA_VISIBLE_DEVICES=1 python experiments.py --dataset mnist --arch carlini_cnn --lambda1 0.005 --lambda2 0.005 --test_lp inf --solver prox --embedding scattering
#CUDA_VISIBLE_DEVICES=0 python experiments.py --dataset mnist --arch carlini_cnn --lambda1 0.999 --lambda2 0.999 --test_lp inf --solver active_refined --embedding scattering
