...
CUDA_VISIBLE_DEVICES=0 python experiments.py --dataset mnist --arch carlini_cnn --lambda1 0.99 --lambda2 0.99 --test_lp inf --solver active_refined --embedding warp --realizable
