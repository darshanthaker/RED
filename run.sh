...
#CUDA_VISIBLE_DEVICES=2 python experiments.py --dataset mnist --arch carlini_cnn --lambda1 5 --lambda2 15 --test_lp inf --del_threshold 0.2 --regularizer 4
...
CUDA_VISIBLE_DEVICES=0 python experiments.py --dataset mnist --arch carlini_cnn --lambda1 0.1 --lambda2 0.1 --test_lp inf --solver active_refined 
#CUDA_VISIBLE_DEVICES=2 python experiments.py --dataset mnist --arch carlini_cnn --lambda1 5 --lambda2 15 --test_lp inf --del_threshold 0.2 --regularizer 4
