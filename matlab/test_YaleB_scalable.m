...
lambda1 =0.2;%regularization parameter used in c_s and c_a updates
lambda2 =0.1; %1 %regularization parameter for c_a updates
no_attacks=2; %number of different attacks
classes_no=38; %number of different classes
...
%load linf pertubed test samples
load('Users/paris/Google Drive/Hyppocrates/Ongoing/RED/test_y.mat');
test_y = data;
clear data;


siz_blk_s = 55; %size of signal blocks
%%
